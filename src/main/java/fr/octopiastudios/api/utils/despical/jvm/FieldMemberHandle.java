package fr.octopiastudios.api.utils.despical.jvm;

import fr.octopiastudios.api.utils.ReflectionUtils;
import fr.octopiastudios.api.utils.despical.jvm.classes.ClassHandle;
...
public class FieldMemberHandle extends NamedMemberHandle {
    ...
    private static final boolean java8 = ReflectionUtils.VER < 9;

    public static final MethodHandle MODIFIERS_FIELD;

    public static final DynamicClassHandle VarHandle = java8 ? null : ReflectionUtils.classHandle()
            .inPackage("java.lang.invoke")
            .named("VarHandle");
    ;
    public static final MethodHandle VAR_HANDLE_SET = java8 ? null : VarHandle.method()
